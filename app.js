...
window.addEventListener('load', () => {
    ...
    console.log('User visit count:', prefs.visitCount);
});
...
console.log(`
╔════════════════════════════════════════╗
║   BUITENZORG LABS - JAVASCRIPT READY   ║
╚════════════════════════════════════════╝

✅ Dark/Light Mode Toggle (Original)
✅ Smooth Scroll Navigation (Original)
✅ Hamburger Menu Toggle (New)
✅ Navbar Scroll Effects (New)
✅ Counter Animation (Original)
✅ Contact Form to WhatsApp (Original)
✅ Portfolio Auto Slider (Original)
✅ Testimonial Auto Slider (Original)
✅ FAQ Accordion (New)
✅ Back to Top Button (New)
✅ Mouse Glow Effect (New)
✅ Form Validation (New)
